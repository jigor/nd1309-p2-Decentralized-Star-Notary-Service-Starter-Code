...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1Address != owner2Address, "You can not exchange stars with yourself");
        require(owner1Address == msg.sender || owner2Address == msg.sender
        , "You must be owner of one of stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(owner == msg.sender, "You must be owner of star");
